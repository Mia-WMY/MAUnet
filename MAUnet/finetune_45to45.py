...
from modules.normalization import  get_norm
import random
import argparse
...
def fine_tuning_cor(net,lr,epoch,num):
    ...
    param_to_train=list(pretrained_model.Up4.parameters())+list(pretrained_model.Up3.parameters())+list(pretrained_model.Up2.parameters())+list(pretrained_model.outc.parameters())\
    ...
    unfrozen_name = [  'ssf_scale3', 'ssf_shift3', 'ssf_scale4',
                     'ssf_shift4',]
    ...
    scheduler = optim.lr_scheduler.StepLR(optimizer, gamma=0.6, step_size=300)

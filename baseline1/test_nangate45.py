...
from modules.process import read_fake_data_nangate45_test
...
def re_real():
    ...
    total_cc = 0
    total_ssim = 0
    file='result_nangate45.txt'
    with open(file,'w') as f:
        f.write("MAE  F1  R2\n")
        for i in range(800,1000):
              tcsv = "/home/wangmingyue/nangate45/BeGAN_{:04d}_ir_drop.csv".format(i)
...
pth='/home/wangmingyue/nangate45'
...
os.chdir(dirpth)
test_x,test_y= read_fake_data_nangate45_test(pth)

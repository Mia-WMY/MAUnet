...
def re_real(test_y,index):
    ...
    with open(file,'w') as f:
        ...
        count=0
        for i in index:
              tcsv = "/home/wangmingyue/date/sky130hd/BeGAN_{:03d}_voltage_map_regular.csv".format(i)
...
model=UNet(in_channels=3,out_channels=1,xmax=xmax,xmin=xmin,ymax=ymax,ymin=ymin)

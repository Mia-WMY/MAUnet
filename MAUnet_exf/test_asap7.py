        ...
        if (os.path.exists(tfile_path)):
            ...
            for pattern in file_pattern:
                ...
                if concat_data is None:
                    ...
                    # print(expand_torch.shape,origin_data.shape)
                    if expand_torch.shape != origin_data.shape:
                        expand_torch = F.interpolate(expand_torch.unsqueeze(0),
                                                     size=(origin_data.size(1), origin_data.size(2)),
                                                     mode="bilinear")
...
os.chdir(dirpth)
# read test data
test_x,test_y= read_fake_data_test_asap7(pth,add_pth)

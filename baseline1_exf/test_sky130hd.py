    ...
    with open(file,'w') as f:
        ...
        for i in index_list:
              ...
              if os.path.exists(tcsv):
                   ...
                   # tensor1 = F.interpolate(tensorx, size=(tensor2.size(0), tensor2.size(-1)), mode="bilinear")
...
model=UNet(in_channels=6,out_channels=1,xmax=xmax,xmin=xmin,ymax=ymax,ymin=ymin)
model.load_state_dict(model_state_dict)
dirpth = f'results/{args.tdir}'
os.chdir(dirpth)
test_x,test_y,index_list= read_fake_data_test_sky130hd(pth)
